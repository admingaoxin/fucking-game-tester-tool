<template>
  <n-card :bordered="false" class="proCard">
    ...
    >
      <template #toolbar>
        <n-button type="primary" @click="addDate">添加部门</n-button>
      </template>
    </BasicTable>
  </n-card>
</template>
...
<script lang="ts" setup>
  ...
  function handleEdit(record) {
    ...
    router.push({name: 'system_department_edit',params:{id:record.id}});
    message.success('您点击了编辑按钮');
  }
  function addDate(){
    router.push({name: 'system_department_edit',params:{id:0}});
  }
</script>
