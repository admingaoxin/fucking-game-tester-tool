...
if __name__ == '__main__':
    logcat_monitor = LogcatMonitor("2f671c2b", "com.camelgames.aoz.debuglz4")
    # 如果有异常日志标志，才启动这个模块
    exceptionlog_list=["fatal exception","has died","error"]
    ...
    RuntimeData.package_save_path = os.path.join(FileUtils.get_top_dir(), 'results', "com.camelgames.aoz.debuglz4", start_time)
